...
pub unsafe fn mm_flip(OP: __m128i, pos: usize) -> __m128i {
    ...
    let flip = _mm256_and_si256(_mm256_andnot_si256(rs, mask), _mm256_cmpgt_epi64(rp, re));
    ...
    let lo = {
        ...
        _mm256_and_si256(
            _mm256_xor_si256(_mm256_add_epi64(tmp, _mm256_set1_epi64x(-1)), tmp),
            mask,
        )
    };

    let lf = _mm256_andnot_si256(pp, lo);
    let flip = _mm256_or_si256(flip, _mm256_andnot_si256(_mm256_cmpeq_epi64(lf, lo), lf));
